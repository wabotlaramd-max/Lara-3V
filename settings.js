...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "vcwUWajJ#DJ9fP7Wl-vSXKViGuNJGYTTopE_GcQqffOGTKq_k-ow", // Add your session id
PREFIX: process.env.PREFIX || ".",
MODE: process.env.MODE || "private",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "94741116425",
DEV: process.env.DEV || "94741116425",
